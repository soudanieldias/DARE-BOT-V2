...
export default async function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-8 bg-zinc-950 p-8">
      <h1 className="text-3xl font-bold text-zinc-50">DARE-bot Admin</h1>
      <p className="max-w-md text-center text-zinc-400">
        Faça login com sua conta Discord para acessar o painel administrativo.
      </p>
      <a
        href="/api/auth/signin/discord?callbackUrl=/dashboard"
        className="flex items-center justify-center gap-3 rounded-lg bg-[#5865F2] px-8 py-4 font-medium text-white transition hover:bg-[#4752C4]"
      >
